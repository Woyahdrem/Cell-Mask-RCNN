...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python cell_rpn.py train --dataset=../../DatasetGeneChannels --weights=coco
"""
...
class CellDatasetDefault(utils.Dataset):
    ...
    def load_cell(self, dataset_dir, subset):
        ...
        # self.add_class("cell", 2, "negative")
        ...
        for a in annotations:
            ...
            polygons = [r['shape_attributes'] for r in a['regions'] if r["region_attributes"]["gene expression"] != "negative"]
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        class_ids = np.ones(num_cells, dtype=np.uint8)
...
def detect(model, channels, image_path):
    # Run model detection
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        detect(model, args.input_channels, image_path=args.image)
    else:
